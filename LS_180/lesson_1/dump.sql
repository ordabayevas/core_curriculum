...
--
-- Name: weather; Type: TABLE; Schema: public; Owner: ordabayeva
--
...
ALTER TABLE public.weather OWNER TO ordabayeva;

--
-- Data for Name: weather; Type: TABLE DATA; Schema: public; Owner: ordabayeva
--
