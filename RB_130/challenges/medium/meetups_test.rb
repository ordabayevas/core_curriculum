...
- 2nd Wednesday of May 2021, the object should be able to determine that the meetup 
for that month will occur on the 12th of May, 2021
- 'first', 'second', 'third', 'fourth', 'fifth', 'last', and 'teenth'
- The case of the strings is not important; that is, 'first' and 'fIrSt'
- there are exactly 7 days that end in '-teenth'
- each day of the week (Monday, Tuesday, ...) will have exactly one date that is the "teenth" 
- The days of the week are given by the strings 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', and 'Sunday'

- class meetup(month, year)
- method determine_date('first', 'Monday')
- method determine_teenth('Monday')

to determine weekday from 0- 6 (0- Sunday):
Date.new(2001, 2, 3).wday # => 6

to determine if some date is one of the weekdays:
monday?tuesday?wednesday?thursday?friday?saturday?sunday? => returns true or false
=end