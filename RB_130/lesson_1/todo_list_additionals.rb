...
class TodoList
  ...
  def select
    ...
    each {|todo_item| selected << todo_item if yield(todo_item)}
    selected
  end
...
# p list.find_by_title("Go to gym") # if not found returns nil
