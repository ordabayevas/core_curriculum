...
def is_valid_walk(array)
  if array.size > 10 || array.size < 10
    return false
  else
    if array.count('n') == array.count('s') && array.count('w') == array.count('e')
      true
    else
      false
    end
...
p is_valid_walk(['w','e','w','e','w','e','w','e','w','e','w','e']) == false # too long 12 min
p is_valid_walk(['w']) == false # too short 1 min
